...
pipeline/               Python collection + extraction scripts (Reddit/App/Play Store, Groq, Google Forms survey)
```
...
python run_pipeline.py collect-survey    # separate: needs Google OAuth setup, see pipeline/README.md
